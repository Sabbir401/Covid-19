<?php
	...
	$sql1="SELECT * FROM `user_reg` WHERE Username='$Uname'";
	...
	if(isset($_POST['submit'])){
	    ...
	    if($pass == $cpass){
	    	$sql= "UPDATE `user_reg` SET `Name`='$name', `Username`='$uname', `Email`='$mail', `Password`='$pass', `C_password`='$cpass', `B_Date`='$date', `Gender`='$gen', `Phone`='$phone', `Address`='$add' WHERE Username='$Uname'";
		    ...
		    <script>
		    	...
		    	window.location.href = "up_user.php";
		    </script>
		    <?php
	    }
