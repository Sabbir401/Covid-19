...
<body>
  <a href="user_work.php"><button class="bt">Back</button></a>
  <div class="container">
    ...
    <div class="profile-attribute">
      <div class="attribute-label">NID:</div>
      <div class="attribute-value"><?php echo $nid; ?></div>
    </div>
    <div class="profile-attribute">
    ...
    <div class="profile-attribute">
      ...
      <div class="attribute-value"><?php echo $occu; ?></div>
    </div>
    <div class="profile-attribute">
    ...
    <div class="profile-attribute">
      <div class="attribute-label">Vaccine Center:</div>
      <div class="attribute-value"><?php echo $vc; ?></div>
    </div>
  </div>
