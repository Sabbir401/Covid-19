<?php
	...
	if(isset($_POST['submit'])){
	    ...
	    if($pass == $cpass){
	    	$sql= "UPDATE `doctor_reg` SET `Name`='$name', `Username`='$uname', `Email`='$mail', `Password`='$pass', `C_password`='$cpass', `B_Date`='$date', `Gender`='$gen', `Phone`='$phone', `Degree`='$degree', `Address`='$add' WHERE Id=$Id";
